...
gamma_ability <- 1 #function input
gamma_parent_educ <- 1#function input
...
beta_max <- c(0.06, 0.06, -0.03, 2, 2) #function input # bounds are from Estimating the return to investments in education: how useful is the standard Mincer equation?

variance_error_wage <- 0.1 #func input
